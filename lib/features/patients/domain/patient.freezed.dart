...
mixin _$Patient {
 ...
 int get id; String get uuid; String get code; String get fullName; Gender get gender; int get age; String get phone; String get cnic; String? get allergies; String? get insurance; DateTime? get lastVisit; int get visitCount; int get balance; PatientStatus get status; String get treatmentSummary;
...
@override
int get hashCode => Object.hash(runtimeType,id,uuid,code,fullName,gender,age,phone,cnic,allergies,insurance,lastVisit,visitCount,balance,status,treatmentSummary);

@override
String toString() {
  return 'Patient(id: $id, uuid: $uuid, code: $code, fullName: $fullName, gender: $gender, age: $age, phone: $phone, cnic: $cnic, allergies: $allergies, insurance: $insurance, lastVisit: $lastVisit, visitCount: $visitCount, balance: $balance, status: $status, treatmentSummary: $treatmentSummary)';
}
...
@useResult
$Res call({
 int id, String uuid, String code, String fullName, Gender gender, int age, String phone, String cnic, String? allergies, String? insurance, DateTime? lastVisit, int visitCount, int balance, PatientStatus status, String treatmentSummary
});
...
/// Create a copy of Patient
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? uuid = null,Object? code = null,Object? fullName = null,Object? gender = null,Object? age = null,Object? phone = null,Object? cnic = null,Object? allergies = freezed,Object? insurance = freezed,Object? lastVisit = freezed,Object? visitCount = null,Object? balance = null,Object? status = null,Object? treatmentSummary = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String uuid,  String code,  String fullName,  Gender gender,  int age,  String phone,  String cnic,  String? allergies,  String? insurance,  DateTime? lastVisit,  int visitCount,  int balance,  PatientStatus status,  String treatmentSummary)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Patient() when $default != null:
return $default(_that.id,_that.uuid,_that.code,_that.fullName,_that.gender,_that.age,_that.phone,_that.cnic,_that.allergies,_that.insurance,_that.lastVisit,_that.visitCount,_that.balance,_that.status,_that.treatmentSummary);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String uuid,  String code,  String fullName,  Gender gender,  int age,  String phone,  String cnic,  String? allergies,  String? insurance,  DateTime? lastVisit,  int visitCount,  int balance,  PatientStatus status,  String treatmentSummary)  $default,) {final _that = this;
switch (_that) {
case _Patient():
return $default(_that.id,_that.uuid,_that.code,_that.fullName,_that.gender,_that.age,_that.phone,_that.cnic,_that.allergies,_that.insurance,_that.lastVisit,_that.visitCount,_that.balance,_that.status,_that.treatmentSummary);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String uuid,  String code,  String fullName,  Gender gender,  int age,  String phone,  String cnic,  String? allergies,  String? insurance,  DateTime? lastVisit,  int visitCount,  int balance,  PatientStatus status,  String treatmentSummary)?  $default,) {final _that = this;
switch (_that) {
case _Patient() when $default != null:
return $default(_that.id,_that.uuid,_that.code,_that.fullName,_that.gender,_that.age,_that.phone,_that.cnic,_that.allergies,_that.insurance,_that.lastVisit,_that.visitCount,_that.balance,_that.status,_that.treatmentSummary);case _:
  return null;
...
class _Patient extends Patient {
  const _Patient({required this.id, required this.uuid, required this.code, required this.fullName, required this.gender, this.age = 0, this.phone = '', this.cnic = '', this.allergies, this.insurance, this.lastVisit, this.visitCount = 0, this.balance = 0, required this.status, this.treatmentSummary = ''}): super._();
...
@override@JsonKey() final  String cnic;
